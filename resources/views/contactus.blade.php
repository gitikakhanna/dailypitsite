...
{{--               			<p>Get in touch with us in case you have any query.</p> --}}
            		</div>
	        	...
	        	<div class="col-lg-4">
	          		<div class="media contact-info">
	            		...
	            		<div class="media-body">
	              			<h3>Delhi, India.</h3>
	              			<p> H-6/205, 2ND FLOOR, AGARWAL TOWER, OPPOSITE PP JEWELLERSNETAJI SUBHASH PLACENEW DELHI, DELHI 110034</p>
	            		</div>
	          		</div>
	          		<div class="media contact-info">
	            		<span class="contact-info__icon"><i class="ti-tablet"></i></span>
	            		<div class="media-body">
	              			<h3><a href="tel:9210888208">+919210888208, +918053687687</a></h3>
	          		...
	          		<div class="media contact-info">
	            		...
	            		<div class="media-body">
	              			<h3><a href="mailto:info@dailypit.com">info@dailypit.com</a></h3>
